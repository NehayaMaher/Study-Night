...
})({"eD4SR":[function(require,module,exports,__globalThis) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SERVER_PORT = 54891;
...
const createImage = (url, alt)=>{
    ...
    img.src = url;
    img.alt = alt; // Fixed the assignment
    return img;
};
...
const createLabel = (text, htmlFor)=>{
    const label = document.createElement("label"); // Fixed assignment error
...
const createInput = (name)=>{
    ...
    input.name = name;
    input.id = name;
    return input; // Fixed return statement
};
...
},{"../images/homePage.png":"9QOwg","./utilityRenderFunctions.js":"7Z6eA","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"9QOwg":[function() {},{}]},["eD4SR","dkgmw"], "dkgmw", "parcelRequireccf0", {})
